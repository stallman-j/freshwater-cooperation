...
gdelt_gkg_one_day <- function(date,
                              ...
                              data_path = file.path("C:","data","01_raw","GDELT","gkg","gkg")){
  ...
  # keep the gkg that has water in a theme
...
system.time(
  gdelt_gkg_one_day(date = "2017-07-25")
)
...
n_cores <- detectCores() - 4
  ...
  rstudioapi::restartSession(command = "source(file.path('P:','Projects','environment','code','01_download','01_download_gdelt_gkg.R'))")
