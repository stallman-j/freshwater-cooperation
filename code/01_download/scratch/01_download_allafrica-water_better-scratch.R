...
next_button <- remDr$findElement(using = "xpath", "//table/tbody/tr/td[3]/ul/li/a/b")
next_button$clickElement()

Sys.sleep(sample(x = c(2,10:22,44,58,8), size = 1)) # Give page time to load
...
#remDr$navigate("https://allafrica.com/search/advanced.html?q=kariba+dam&g=all&c=&c=water&p=&sd=19961017&ed=20230822&st=3&di=1&os=0#results")
