...
# https://github.com/dondealban/getcrucldata/blob/master/getCRUCLdata.R
...
pre_raster <- get_CRU_stack(pre = TRUE)

# Write Raster Stack Objects --------------

path <- file.path(data_external_raw,"CRU_TS","pre.tif")

terra::writeRaster(pre_raster$pre,
            filename = path)
