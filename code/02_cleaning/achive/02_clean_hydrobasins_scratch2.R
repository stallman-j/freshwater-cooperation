...
## manually scroll over and get the basin IDs we want ----
  ...
  # split out the countries and the hydroRIVERS with the countries split into a parallelizable separate list
  my_countries <- get_countries_from_basins(desired_basin_ids)
  
  my_list <- get_countries_for_splitting()
