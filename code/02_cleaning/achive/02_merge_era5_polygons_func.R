...
#' Extracts ERA_5 rasters to polygons 
#' 
#' \code{raster_extract_to_panel} returns polygon shapefiles with longitudinal data from rasters
#' extracted to those polygons and writes two sf files, one with the polygons shapefiles
...
#' @param raster a terra raster, currently required to be from 0-360 degrees longitude and -90 to 90 degrees latitude,
#' must have a time dimension given
#' @param values_varname character variable name
#' @param 
