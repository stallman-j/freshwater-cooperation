...
# DHS Data ----
  ...
  path <- file.path(data_external_raw,"DHS","UGIR7BSV.rds")
  
  IRdata <- readRDS(path)
  
# copied from 
  # https://github.com/DHSProgram/DHS-Indicators-R/blob/main/Chap08_CM/CM_PMR.R
  ...
  IRdata_PMR <- IRdata %>%   
                  select(caseid,v001,v002,v003,v005,v008,v011,v017,v018,v021,v022,v023,v024,v025,v106,v190,v231,v242,
                         `vcal$1`) %>%
                rename(vcal_1 = `vcal$1`)
  
  
  # drop any case without a birth or termination in the calendar, just to speed up the code
  # trimws() is trim white space
