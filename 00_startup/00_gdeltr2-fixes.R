...
get_urls_gkg_15_minute_log <- function(version = "english") {
  ...
  url <-
    ...
    url <- 'https://data.gdeltproject.org/gdeltv2/masterfilelist-translation.txt'
  }
